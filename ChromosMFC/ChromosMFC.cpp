...
// ChromosMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChromosMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CChromosMFCApp

CChromosMFCApp::CChromosMFCApp()
{
...
// Единственный объект CChromosMFCApp

CChromosMFCApp theApp;


// Инициализация CChromosMFCApp

BOOL CChromosMFCApp::InitInstance()
{
